...
class Client(discord.Client):
    ...
    async def set_random_presence(self) -> None:
        activities = [
            discord.Game("Barbie Horse Adventure"),
            discord.Game("Connect Four"),
            discord.Game("Fortnite"),
            discord.Game("Minecraft"),
            discord.Game("Neovim"),
            discord.Activity(type=discord.ActivityType.listening, name="Nickelback"),
            discord.Activity(type=discord.ActivityType.watching, name="Mean Girls"),
        ]
    ...
    async def on_connect(self) -> None:
        self.loop.create_task(self.set_random_presence())
